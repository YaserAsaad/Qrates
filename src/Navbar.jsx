    ...
    <div className="sm:mt-4 max-md:m-4 sm:m-6 items-center flex z-100  max-md:justify-between">
      ...
      <div className="uppercase text-xs flex ">
        ...
        <div className=" flex md:gap-2 list-none items-center">
          <label className="max-sm:mr-6 swap swap-rotate items-center">
          ...
          <details className="dropdown md:hidden dropdown-end ">
            <summary
              ...
              className=" m-1 btn text-3xl ml-4"
            >
              ☰
            </summary>
            {isOpen === true && (
              <ul className="p-2 shadow menu dropdown-content z-[1] bg-base-100 rounded-box w-[25rem] mt-4 border-2 h-[40rem] border-black text-3xl font-semibold flex flex-col relative ">
                <li>
